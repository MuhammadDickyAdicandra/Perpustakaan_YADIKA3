 ...
 * @author server
 */
public class tentangkamibijak extends javax.swing.JFrame {

    /**
     * Creates new form tentangkamibijak
     */
    public tentangkamibijak() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel16.setText(" Kebijakan Privasi");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 37, -1, 50));

        BG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/kebijakanmembercoy.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tentangkamibijak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
