 ...
 * @author server
 */
public class tentangkamibatas extends javax.swing.JFrame {

    /**
     * Creates new form tentangkamibatas
     */
    public tentangkamibatas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel16.setText(" Batas Tanggung Jawab");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 37, -1, 50));

        BG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/batasmembercoy.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tentangkamibatas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
