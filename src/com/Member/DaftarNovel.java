 ...
 * @author server
 */
public class DaftarNovel extends javax.swing.JFrame {
...
//}
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        ...
        try {
            ...
            while (hasil.next()) {
                ...
                String spengarang = hasil.getString("pengarang");
                String spenerbit = hasil.getString("penerbit");
                String stahunterbit = hasil.getString("tahun_terbit");
                String sjumlah_barang = hasil.getString("jumlah");
                String[] data = {sjudul,spengarang,spenerbit,stahunterbit,sjumlah_barang};
                tabmode.addRow(data);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarNovel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
