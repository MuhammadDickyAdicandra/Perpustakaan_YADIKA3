 ...
 * @author server
 */
public class DaftarKomik_Admin extends javax.swing.JFrame {
    private Connection conn = new New_ConnectDB().connect();
    private DefaultTableModel tabmode;
    private DefaultTableModel datakomik;
    

    /**
     * Creates new form DaftarKomik
     */
    public DaftarKomik_Admin() {
        initComponents();
        dataTable();
    ...
    protected void dataTable() {
        ...
        String sql = "select judul,penerbit,pengarang,tahun_terbit,jumlah from data_buku where kategori='komik'";//asc paling kecil
        ...
        try {
            ...
            while (hasil.next()) {
                ...
                String[] data = {judul,penerbit, pengarang, tahun_terbit, jumlah};
                tabmode.addRow(data);
...
//}
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 85, -1, -1));

        jScrollPane1.setBorder(javax.swing.BorderFactory.createCompoundBorder());

        tableout.setBackground(new java.awt.Color(255, 255, 102));
        tableout.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 255, 102)));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(442, 6, 230, 20));
    ...
    private void txtcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcariActionPerformed
        ...
        tabmode = new DefaultTableModel(null, baris);
        tableout.setModel(tabmode);
        String sql = "select * from data_buku where judul = '"+txtcari.getText()+"' and kategori='komik'";
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
                ...
                String[] data = {sjudul,spengarang,spenerbit,sjumlah_barang};
                tabmode.addRow(data);
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        ...
        tabmode = new DefaultTableModel(null, baris);
        tableout.setModel(tabmode);
        String sql = "select * from data_buku where judul like '%"+txtcari.getText()+"%' and kategori='komik'";
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarKomik_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
