...
import static com.Admin.Home_Admin.jLabel7;
import com.Member.*;
 ...
 * @author server
 */
public class DaftarMajalah_Admin extends javax.swing.JFrame {
    private Connection conn = new New_ConnectDB().connect();
    private DefaultTableModel tabmode;


    /**
     * Creates new form DaftarMajalah
     */
    public DaftarMajalah_Admin() {
        initComponents();
        dataTable();
    ...
    protected void dataTable() {
        ...
        String sql = "select judul,penerbit,pengarang,tahun_terbit,jumlah from data_buku where kategori='Majalah'";//asc paling kecil
...
//}
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Majalah");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 85, -1, -1));
    ...
    private void txtcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcariActionPerformed
        ...
        tabmode = new DefaultTableModel(null, baris);
        tableout.setModel(tabmode);
       String sql = "select * from data_buku where judul ='"+txtcari.getText()+"' and kategori='majalah'";
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        ...
        tabmode = new DefaultTableModel(null, baris);
        tableout.setModel(tabmode);
       String sql = "select * from data_buku where judul like '%"+txtcari.getText()+"%' and kategori='majalah'";
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarMajalah_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
